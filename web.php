...
Route::group(['prefix' => 'teacher', 'middleware' => ['teacher']], function () {
    ...
    Route::get('/profile', 'User\LoginUserController@getProfile');
        ...
        //tani
    Route::get('/profile/updatePass', 'User\UserController@changePassword');
    Route::post('/profile/updatePass', 'User\UserController@updatePassword');
   
    Route::get('/profile/profilepicture', 'User\UserController@getProfileAvatar')->name('profileavatar');
    Route::post('/profile/profilepicture', 'User\UserController@profilePictureUpload')->name('profileavatar');
