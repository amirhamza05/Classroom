...
Route::group(['prefix' => 'teacher', 'middleware' => ['teacher']], function () {
    ...
    Route::group(['prefix' => 'courses/{course_id}', 'middleware' => ['course']], function () {
        ...
        Route::group(['middleware' => ['course.admin']], function () {
         ...
         Route::post('courses/comment/{course_id}', 'CommentController@store')->name('comment.store');
         Route::post('/comment-reply/{comment_id}', 'CommentReplyController@store')->name('reply.store');
